...
caffe_model_path = 'E:/face_attribute_recognition_yqy/yht/mobilenet_age/mobilenet_v2.caffemodel'
solver_config_path ='E:/face_attribute_recognition_yqy/age_solver_180817.prototxt'
solver = caffe.get_solver(solver_config_path)

### solve
niter = 500001  # EDIT HERE increase to train for longer
test_interval = 1000
# test_interval=10
...
for it in range(niter):
    ...
    if it % test_interval == 0:
        ...
        MAE=0
        print age
        print solver.net.blobs['labels'].data[:,0,0].T
        for i in range(18):
